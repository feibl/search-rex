...
class RecommendationTestCase(BaseTestCase):
    ...
    def test__isolated_query__returns_1_recommendation(self):
    ...
    def test__unseen_and_unrelated_query__returns_no_recommendation(self):
        recs = self.sut.recommend(
    ...
    def test__unseen_but_related_query__returns_recommendation(self):
        recs = self.sut.recommend(
